(() => {
  ...
  function createAudio() {
    ...
    let engineOsc;
    let engineGain;
    const music = new Audio("assets/audio/soundtrack.mp3");
    music.loop = true;
    music.volume = .25;
    music.preload = "auto";
    music.addEventListener("canplaythrough", () => { state.musicReady = true; }, { once: true });
    music.addEventListener("error", () => { state.musicReady = false; }, { once: true });
